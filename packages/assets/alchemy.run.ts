...
import { DEFAULT_ASSETS_BUCKET_NAME, DEFAULT_ASSETS_HOST } from "./src/config.ts";

export default Alchemy.Stack(
    "ArtisannPortfolioAssets",
    ...
    Effect.gen(function* () {
        ...
        const host = yield* Config.nonEmptyString("ASSETS_HOST").pipe(
