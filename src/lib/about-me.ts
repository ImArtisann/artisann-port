...
export const portfolio: PortfolioConfig = {
	...
	sectionCopy: {
		experience: {
			...
			summary: {
				...
				mobile:
					"Device intelligence, forensic analysis, and mobile testing infrastructure—connected by dependable execution.",
			},
		},
		work: {
			...
			summary: {
				...
				mobile:
					"Four solo bets built end to end—live, open source, and sunsetted. Each one became something people could use.",
			},
		},
		openSource: {
			...
			summary: {
				...
				mobile:
					"Three public repositories, shown through the problems they solve and the real changes that moved each codebase forward.",
			},
		},
	},
	workExperiences: [
		{
			...
			description: {
				...
				mobile:
					"Build device-test automation and trace SIP, VoLTE, and IMS signaling with telecom protocol teams.",
			},
			proof: {
				desktop:
			...
			technologyLabel: { desktop: "TYPESCRIPT / JAVA / PYTHON", mobile: "TS / JAVA / PYTHON" },
	...
	personalProjects: [
		{
			...
			description: {
				...
				mobile:
					"Official Notion integration for turning live data into customizable website widgets.",
			},
	...
	openSourceProjects: [
		...
		},
		{
			...
			description: {
				...
				mobile:
					"Subscribe to new trades and newly created coins through a focused real-time package.",
			},
		...
		audiences: [
			{
				...
				detail: {
					desktop: "Developer tooling, product systems, and dependable execution across the stack.",
			...
			},
			{
				...
				detail: {
					desktop: "Workflow automation, systems integration, and focused software builds.",
	...
	footer: {
		...
		elsewhere: [
			{ desktopLabel: "GitHub ↗", mobileLabel: "GitHub ↗", href: "https://github.com/ImArtisann" },
			{
