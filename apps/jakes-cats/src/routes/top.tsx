                        ...
                        return (
                            <li key={entry.photo.key}>
                                <Link
                                    to="/photos/$id"
                                    params={{ id }}
                                    className="border-line bg-card hover:border-pass focus-visible:ring-ink flex items-center gap-3 rounded-2xl border p-3 transition-colors focus-visible:ring-2 focus-visible:outline-none"
                                >
